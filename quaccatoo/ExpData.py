...
class ExpData:
    ...
    Class Attributes
    ----------
    - variable (np.ndarray): array containing the variable data
    - results (np.ndarray, list): array or list of arrays containing the results data
    - variable_name (str): name of the variable
    - result_name (str): name of the results

    Class Methods
    -------------
    - subtract_results_columns: substracts the results of the negative column from the positive column
    - background_correction: substracts a background value from the results
    ...
    def __init__(self, file_path, variable_column=0, results_columns=1, variable_name='Time', result_name='Expectation value', **loadtxt_args):
        ...
        Parameters
        ----------
        - file_path (str): path to the file containing the experimental data
        - variable_column (int): column index of the variable
        - results_columns (int, list): column index of the results
        - variable_name (str): name of the variable
        - result_name (str): name of the results
        - **loadtxt_args (dict): additional arguments for the np.loadtxt function
        """
